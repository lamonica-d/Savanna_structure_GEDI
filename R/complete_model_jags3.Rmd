...
vals <- data.frame(matrix(nrow=4,ncol=4))
...
vals["log10delta_max",] = c(-4.9,-3,-3.2,-2.2)
...
inits <- list(
 ...
 list(
       ...
       log10delta_max = vals["delta_max",2],
 ...
 list(
       ...
       log10delta_max = vals["delta_max",3],
 ...
 list(
       ...
       # log10delta_max = vals["log10delta_max",2],
       log10delta_max = vals["delta_max",4],
