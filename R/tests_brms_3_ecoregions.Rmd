...
# Au final pour la chaîne la plus rapide :
...
# pendant ce temps-là la chaîne 1 n'en est qu'à 40% :D
...
# Pour enregistrer manuellement la chaîne sans utiliser l'argument "file" dans brm() :

# saveRDS(mod,file="test_brms_Guinean2.RDS")
# mod2 <- readRDS("test_brms_Guinean2.RDS")

# Pour enregistrer en pdf le visuel des chaînes :
...
View(ok)
# semble marcher mais les chaînes sont mises à la suite les une des autres
