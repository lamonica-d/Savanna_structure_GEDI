...
```
```{r}
# Save/Read the concatenation of all data (complete_corresponding_table)
...
```{r}
#standardize version of data
sub_table <- readRDS(file = file.path(path_to_Savanna_structure_GEDI_folder,
                                             "rawdata",
                                             "complete_corresponding_table_without_duplicate.RDS"
                                             )
                            )
