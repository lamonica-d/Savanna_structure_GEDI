...
## For tests :
# list_of_ouputs = list.files(path = file.path(path_to_Savanna_structure_GEDI_folder,"outputs","canopy_cover"),full.names=TRUE)[1]
# names_of_outputs = list.files(path = file.path(path_to_Savanna_structure_GEDI_folder,"outputs","canopy_cover"),full.names=FALSE)[1]
