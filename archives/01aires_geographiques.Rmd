...
```{r}
# Visualisation des aires géographiques avec canopy_cover
...
```{r}
# Visualisation des aires géographiques avec fire_freq
...
```{r}
# Visualisation des aires géographiques avec rh98
...
# for (i in 1:1){
  ...
  # Pas de données manquantes pour rh98
