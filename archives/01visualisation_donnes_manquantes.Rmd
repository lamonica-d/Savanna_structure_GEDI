...
```{r}
# Visualisation des données manquantes totales
...
plot <- ggplot(
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  # Customize plot labels and title
  labs(title = "Pourcentage de données manquantes (au moins une variable NA)", x = "X-axis Label", y = "% données manquantes") +
  ylim(0,1)
...
```{r}
# Visualisation des données manquantes
# de feu ET de pluie ET de canopy_cover ET "missing" simultanément
...
plot <- ggplot(
               ...
               theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
               labs(
               title = "% de données manquantes feu + pluie + canopy_cover + au moins une variable",
               x = "X-axis Label",
               y = "% données manquantes"
               ) +
               ylim(0, 1)
